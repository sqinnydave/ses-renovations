...
export function Quote() {
  ...
  return (
    <div id="quote-container" className="quote-container w-full max-w-screen-xl py-4 pt-0 text-white md:pb-0">
      <form id="quoteForm" onSubmit={sendEmail}>
        <div id="mainForm" className="grid grid-cols-12 items-center gap-4 md:gap-6">
          <div className="col-span-12 mb-3 text-center md:text-left">
          ...
          <div className="col-span-12 pt-3 text-center">
            <Button color="green" size="4" className="w-full px-6 py-4 md:w-auto">
